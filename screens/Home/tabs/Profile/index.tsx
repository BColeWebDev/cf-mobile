...
export default function ProfileScreen({navigation}) {
 ...
 <Text color='#03dac5b3' style={{textAlign:"center",textTransform:"capitalize"}}>{currentUser.existingUser?.experience}</Text>
      ...
      <Box style={{display:"flex", justifyContent:"center", height:"30%", width:"100%", alignItems:"center"}}>
        <Text style={{textAlign:"left", width:"100%", fontSize:20, color:"white"}}>Bio</Text>
        <Text color='white'>{currentUser.existingUser?.bio ? currentUser.existingUser?.bio : "N/A"}</Text>
      </Box>
    </Box>   
