...
const SignUpNamesScreens = ({navigation}) => {
  ...
  return (
    <View style={style.container}>
             <ScrollView style={{ width:"100%", height:"100%",flex:1, marginLeft:"auto", marginRight:"auto" }}>
             <Box  style={{display:"flex",alignItems:"flex-start", marginTop:110}}>
        {/* <CfIcon/> */}
        <Text style={{fontSize:35,marginLeft:20, fontWeight:"600", color:"white"}}>
        Sign Up
       </Text>
            </Box> 
             <Box style={{width:"90%",flex:1, marginTop:"10%", justifyContent:"center",alignItems:'center', marginLeft:"auto",marginRight:"auto"}}>
             <TextInput 
      label='First Name' 
      ...
      />
             </Box>
             {
              ...
              <Button  style={{width:300, height:50, marginTop:"40%", alignItems:"center", justifyContent:"center"}}   color='#FAC000' variant={"outlined"} title={"Next"} onPress={()=>navigation.navigate("Login")}></Button>
              </Box>
              :  null
             }
